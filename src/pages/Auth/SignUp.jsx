...
const SignUp = () => {
  ...
  return (
    <div className="grid grid-cols-2 items-center w-full h-screen mx-auto gap-x-[81px]">
      ...
      <div className="item">
        <ToastContainer />
        <h2 className="text-[36px] text-[#1A1919] font-['ArialBlack']">
          Ro'yhatdan o'tish
        </h2>
        <h3 className="my-4 text-sm">
          Avval ro'yhatdan otganmisiz?{" "}
          <Link to="/signin" className="font-bold text-indigo-600">
            Kirish
          </Link>
        </h3>
        <Form
        ...
        >
          ...
          >
            <Input
              className="rounded-lg outline-none py-2 text-xl"
              placeholder="Ism"
            />
          </Form.Item>
          ...
          >
            <div className="border rounded-lg overflow-hidden">
              ...
              />
              <InputMask
                className="w-[80%] focus:ring-0 rounded-lg text-xl border-none"
                mask="(99)999-99-99"
                maskChar="-"
                type="tel"
          ...
          >
            <Input.Password
              className="py-2 outline-none text-xl bg-transparent"
              placeholder="Parol"
            />
          </Form.Item>
          ...
          >
            <Button
              className=" bg-slate-700 text-white rounded-2xl w-full mt-4 text-xl h-[50px]"
              htmlType="submit"
            >
              Ro'yhatdan o'tish
            </Button>
