        ...
        <div className="card-auth w-[173.33px] rounded-[15px] cursor-pointer">
            ...
            <div className="card-body-auth pt-[12px] pb-[22px]">
                ...
                <div className="flex items-center justify-around text-[16px]">
                    <span className="flex items-center justify-center gap-x-2"><i class='bx bxs-book-alt text-[20px]'></i> <span>34</span></span>
                    <span className="flex items-center justify-center gap-x-2"><i class='bx bx-headphone text-[20px]'></i> <span>13</span></span>
                </div>
            </div>
        </div>
    );
